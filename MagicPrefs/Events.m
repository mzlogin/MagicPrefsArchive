...
-(void) tap_start{
    ...
    if (eventTap == NULL){
        ...
        if(eventTap){
            ...
            // Retry after 5 seconds in case the user just granted Accessibility permission
            [NSTimer scheduledTimerWithTimeInterval:5.0 target:self selector:@selector(tap_start) userInfo:nil repeats:NO];
        }
    }else{
